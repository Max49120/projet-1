<!DOCTYPE html>
<!--https://script.google.com/macros/s/AKfycbyGWMIN2reyktEy1yO4FGdf7sqVslRqHhpRVu4KHaJwPalGlps/exec-->
<html lang="en">
<head>
    <meta charset="utf-8">
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
                            <h1 class="hero-title mt-0">Confiez-nous la rédaction de vos contenus</h1>
                            <div class="entreprise">
                                <h4 class="title-entreprise">Entreprise</h4>
	                           <p class="hero-paragraph">Externaliser la rédactions de vos contenu marketing, gagnez du temps et recevez des textes de qualité.</p>
	                           <p class="hero-cta"><a class="button button-primary button-shadow" href="#">Commander</a></p>
                            </div>
                            <div class="redacteur">
                                <h4 class="title-redacteur">Rédacteur</h4>
                                <p class="hero-paragraph">Rédigez quand vous le souhaitez, gagnez votre autonomie financière grâce à de nouvelles opportunités.<br/><br/></p>
	                           <p class="hero-cta"><a class="button button-primary button-shadow1 blue" href="redacteurs.php">Devenir Rédacteur</a></p>
                            </div>
						</div>
                ...
                <div class="container">
                    <div class="features-extended-inner section-inner has-top-divider">
                        <div class="features-extended-header text-center">
                            <div class="container-sm">
                                <h2 class="section-title mt-0">Meet Sienna</h2>
